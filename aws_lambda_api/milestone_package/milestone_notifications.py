...
def handle_scheduled_notifications(dynamodb: Any, system_table: Any, subscribers_table: Any) -> Dict[str, Any]:
    ...
    for subscriber in all_subscribers:
        try:
            ...
            social_query = query_string  # Just the query params, URL path is in template
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if event.get('real_test_email'):
            ...
            social_query = urlencode(social_params)  # Just the query params, URL path is in template
