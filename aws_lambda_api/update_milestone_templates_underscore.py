#!/usr/bin/env python3
"""
Script to update level_template field in all milestones to use underscores
Pattern: m_0, m_1, m_2... for male, f_0, f_1, f_2... for female
"""
...
def update_milestone_templates():
    """Update all milestone level_template fields to use underscores"""
    
    print("🔄 Updating milestone templates to use underscores in DynamoDB...")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    for milestone in milestones:
        ...
        # Generate level_template with underscore: m_0, m_1, m_2... or f_0, f_1, f_2...
        prefix = 'm' if gene == 'male' else 'f'
        new_template = f"{prefix}_{level}"
        ...
        if old_template != new_template:
            print(f"  ✅ Level {level:2d} ({gene:6s}) - {title:30s} → {old_template:4s} → {new_template}")
            updated_count += 1
        else:
            print(f"  ⚪ Level {level:2d} ({gene:6s}) - {title:30s} → {new_template} (no change)")
    ...
    # 4. Create backup
    print("\n💾 Creating backup...")
    backup_file = 'milestone_templates_underscore_backup.json'
    ...
    print("  Male:   m_0, m_1, m_2, m_3, ...")
    print("  Female: f_0, f_1, f_2, f_3, ...")
    print("\n📊 Summary:")
    ...
    for milestone in milestones[:5]:
        ...
        print(f"  {template:6s} - {title} ({gene})")
