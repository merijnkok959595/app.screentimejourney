                          ...
                          <div style={{marginBottom: '0'}}>
                            ...
                            <div style={{marginBottom: '16px'}}>
                              <video 
                                ...
                                preload="none"
                                playsInline
                                poster={`${currentFlow.steps[currentFlowStep - 1].media_url.replace('.mov', '').replace('unlock', 'thumbnailunlock').replace('screentime', 'thumbnailscreentime').replace('profile', 'thumbnailprofile').replace('pincode', 'thumbnailpincode')}.jpg?v=${Date.now()}`}
